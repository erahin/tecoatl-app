    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('uploadFileSubFolder', ['idAdministrative' => $administrative->id, 'folder' => $folder, 'subfolder' => $subfolder]) }}"
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-danger"
                                    href="{{ route('subFolderList', ['idAdministrative' => $administrative->id, 'folder' => $folder]) }}"><i
